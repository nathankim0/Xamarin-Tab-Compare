...
namespace XamarinTabCompare.Fragments
{
    public class SecondView : ContentView
    {
        ...
        public SecondView()
        {
            ...
            System.Diagnostics.Debug.WriteLine("SecondView Loaded!");
        }

        public void Run()
        {
            System.Diagnostics.Debug.WriteLine("Second View Running...");
            ...
            System.Diagnostics.Debug.WriteLine("Second View Done!");
        }
    }
}
